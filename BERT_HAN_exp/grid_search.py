...
files = ['../Datasets/Sarcasm/sarcasm_dataset_22.pkl', '../Datasets/Hate/hate_dataset_22.pkl', '../Datasets/Humour/humour_dataset_22.pkl']
files = files[:1]

for fil in files:
    for lr in learning_rates:
        for hs in hidden_sizes:
            os.system(f'python bert_cross_val.py --lr {lr} --hs {hs} --filename {fil} -e {epochs}')